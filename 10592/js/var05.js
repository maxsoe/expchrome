console.log("Setting variant 5");
var currentVariant = chrome.extension.getURL("/html/var05.html");
...
console.log("Setting variant 5");
var description = "Add point language to burn message and associate to price (below)";
