var description = "Book, in the popup";
...
function setVariant(variant) {
  ...
  // Insert the content into the page
    $.get( currentVariant, function( myHTML ) {
      ...
      var buttonInPin = $(myHTML).filter('.btn-secondary')[0].outerHTML;

      console.log("button:", buttonInPin);
      $(".map-canvas .pushpin-address .address").after(buttonInPin);
