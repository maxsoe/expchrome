var description = "'Book Now' above Points of interest";
...
function setVariant(variant) {
  ...
  // Insert the content into the page
    $.get( currentVariant, function( myHTML ) {
      ...
      var buttonAbovePOIs = $(myHTML).filter('.btn-book')[0].outerHTML;

      console.log("button:", buttonAbovePOIs);
      // $(".map-header .star-rating-wrapper").after(buttonInPin);
      $(".legend h6:first-of-type").before(buttonAbovePOIs);
